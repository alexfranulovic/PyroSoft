...
/**
 * Generate HTML form inputs for configuring 'facial'.
 *
 ...
 *
 * @return string - A string containing HTML form inputs and select boxes for configuring 'facial'.
 */
function inputs_for_facial(string $type_form, $counter, array $data = [])
{
    $type_field = 'facial';
    ...
    $advanced_options.= input('facial', $type_form,
        [
            'size' => 'col-12" rows="3"',
