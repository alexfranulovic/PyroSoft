...
/**
 * Generate HTML form inputs for configuring 'submit_button'.
 *
 ...
 *
 * @return string - A string containing HTML form inputs and select boxes for configuring 'submit_button'.
 */
function inputs_for_submit_button(string $type_form, $counter, array $data = [])
{
    global $info;
    ...
    $res.= input('selection_type', $type_form,
        [
            ...
            'Options' => [
                [
                    'value' => 1,
                    'display' => 'Permitir agendamento',
                    'name' => "Fields[$counter][allow_schedule]",
                    'checked' => $data['allow_schedule'] ?? '',
                ],
                [
                    'value' => 1,
                    'display' => 'Largura 100%',
