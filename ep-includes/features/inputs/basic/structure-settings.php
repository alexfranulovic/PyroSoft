...
/**
 * Generate HTML form inputs for configuring 'basic'.
 *
 ...
 *
 * @return string - A string containing HTML form inputs and select boxes for configuring 'basic'.
 */
function inputs_for_basic(string $type_form, $counter, array $data = [])
{
    $type_field = 'basic';
