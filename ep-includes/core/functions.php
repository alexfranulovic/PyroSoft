...
require_once __DIR__ ."/crud-functions.php";                    // Will be feature/
require_once __DIR__ ."/seo-functions.php";                     // Will be feature/
require_once __DIR__ ."/rest-api-functions.php";                // Will be feature/
require_once __DIR__ ."/cron-functions.php";                    // Will be feature/
require_once __DIR__ ."/token-functions.php";                   // Will be feature/
require_once __DIR__ ."/loader-functions.php";
require_once __DIR__ ."/general-functions.php";
require_once __DIR__ ."/file-functions.php";                    // Will be feature/
require_once __DIR__ ."/email-functions.php";
require_once __DIR__ ."/alert-messages.php";
require_once __DIR__ ."/form-input-functions.php";              // Will be feature/
